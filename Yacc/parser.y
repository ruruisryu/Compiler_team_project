...
%token TIDENT TNUMBER TCONST TIF TELSE TINT TVOID TWHILE TRETURN
%token TADD TSUB TMUL TDIV TMOD TASSIGN TNOT TLESS TGREAT
%token TLPAREN TRPAREN TCOMMA TLBRACE TRBRACE TLBRACKET TRBRACKET TSEMI
%token TEQUAL TNOTEQU TLESSE TGREATE TINC TDEC
...
assignment_exp              : logical_or_exp                            { semantic(54); }
                            ...
                            | unary_exp TADD assignment_exp             { semantic(56); }
                            | unary_exp TSUB assignment_exp             { semantic(57); }
                            | unary_exp TMUL assignment_exp             { semantic(58); }
                            | unary_exp TDIV assignment_exp             { semantic(59); }
                            | unary_exp TMOD assignment_exp             { semantic(60); }
                            ;
