...
compound_st                : TLBRACE opt_dcl_list opt_stat_list TRBRACE                      { semantic(23); }
                           | TLBRACE opt_dcl_list opt_stat_list error                        { yyerrok; ReportParserError("compound_st MISSING RBRACE"); };
...
assignment_exp             : logical_or_exp                                                  { semantic(54); }
                           ...
                           | unary_exp TASSIGN error                                         { yyerrok; ReportParserError("assignment_exp"); }
                           | unary_exp TADDASSIGN error                                      { yyerrok; ReportParserError("assignment_exp"); }
                           | unary_exp TSUBASSIGN error                                      { yyerrok; ReportParserError("assignment_exp"); }
                           | unary_exp TMULASSIGN error                                      { yyerrok; ReportParserError("assignment_exp"); }
                           | unary_exp TDIVASSIGN error                                      { yyerrok; ReportParserError("assignment_exp"); }
                           | unary_exp TMODASSIGN error                                      { yyerrok; ReportParserError("assignment_exp"); }
                                                                                             ;
